...
public class Resources {
    ...
    private static class FontInfo {
        ...
        private FontInfo(final String fontName, final int fontSize) {
    ...
    public static Font getFont(final String fontName, final int fontSize) {
        return getFont(fontName, fontSize, SWT.NORMAL);
    }

    public static Font getFont(final String fontName, final int fontSize, final int style) {
        final FontInfo fontInfo = new FontInfo(fontName, fontSize);

...
public class PersistentXmlImpl extends Persistent {
    ...
    private PersistentContext getCurrentContext(final ERDiagram diagram) {
        return getContext(diagram.getDiagramContents());
    }
    ...
    private String createXML(final ERDiagram diagram) {
        ...
        xml.append("\t<category_index>").append(diagram.getPageIndex()).append("</category_index>\n");
        ...
        xml.append("\t</default_color>\n");
        xml.append(tab(createXMLColor(diagram.getColor())));
        ...
        final PersistentContext context = getCurrentContext(diagram);
    ...
    private String createXML(final DBSetting dbSetting) {
        final StringBuilder xml = new StringBuilder();
    ...
    private String createXML(final DiagramContents diagramContents, final PersistentContext context) {
        final StringBuilder xml = new StringBuilder();
    ...
    private String createXML(final GroupSet columnGroups, final PersistentContext context) {
        final StringBuilder xml = new StringBuilder();
    ...
    private String createXML(final List<TestData> testDataList, final PersistentContext context) {
        final StringBuilder xml = new StringBuilder();
    ...
    private String createXML(final TriggerSet triggerSet) {
        final StringBuilder xml = new StringBuilder();
    ...
    private String createXML(final Trigger trigger) {
        final StringBuilder xml = new StringBuilder();
    ...
    private String createXML(final SequenceSet sequenceSet) {
        final StringBuilder xml = new StringBuilder();
    ...
    private String createXML(final Sequence sequence) {
        final StringBuilder xml = new StringBuilder();
    ...
    private String createXML(final TablespaceSet tablespaceSet, final PersistentContext context) {
        final StringBuilder xml = new StringBuilder();
    ...
    private String createXML(final MySQLTablespaceProperties tablespace) {
        final StringBuilder xml = new StringBuilder();
    ...
    private String createXML(final OracleTablespaceProperties tablespace) {
        final StringBuilder xml = new StringBuilder();

        xml.append("<auto_extend>").append(tablespace.isAutoExtend()).append("</auto_extend>\n");
        xml.append("<auto_segment_space_management>").append(tablespace.isAutoSegmentSpaceManagement()).append("</auto_segment_space_management>\n");
    ...
    private String createXML(final PostgresTablespaceProperties tablespace) {
        final StringBuilder xml = new StringBuilder();
    ...
    private String createXML(final Settings settings, final PersistentContext context) {
        final StringBuilder xml = new StringBuilder();
    ...
    private String createXML(final ColumnGroup columnGroup, final PersistentContext context) {
        final StringBuilder xml = new StringBuilder();
    ...
    private String createXML(final TestData testData, final PersistentContext context) {
        final StringBuilder xml = new StringBuilder();
        ...
        final Map<ERTable, TableTestData> tableTestDataMap = testData.getTableTestDataMap();
    ...
    private String createXML(final TableTestData tableTestData, final ERTable table, final PersistentContext context) {
        final StringBuilder xml = new StringBuilder();
    ...
    private String createXML(final DirectTestData directTestData, final ERTable table, final PersistentContext context) {
        final StringBuilder xml = new StringBuilder();
    ...
    private String createXML(final RepeatTestData repeatTestData, final ERTable table, final PersistentContext context) {
        final StringBuilder xml = new StringBuilder();
    ...
    private String createXML(final ChangeTrackingList changeTrackingList) {
        final StringBuilder xml = new StringBuilder();
    ...
    private String createXML(final ExportDDLSetting exportDDLSetting, final PersistentContext context) {
        final StringBuilder xml = new StringBuilder();

        xml.append("<export_ddl_setting>\n");

        xml.append("\t<output_path>").append(escape(exportDDLSetting.getDdlOutput())).append("</output_path>\n");
        xml.append("\t<encoding>").append(escape(exportDDLSetting.getSrcFileEncoding())).append("</encoding>\n");
        xml.append("\t<line_feed>").append(escape(exportDDLSetting.getLineFeed())).append("</line_feed>\n");
        xml.append("\t<is_open_after_saved>").append(exportDDLSetting.isOpenAfterSaved()).append("</is_open_after_saved>\n");
        xml.append("\t<environment_id>").append(context.environmentMap.get(exportDDLSetting.getEnvironment())).append("</environment_id>\n");
        xml.append("\t<category_id>").append(context.nodeElementMap.get(exportDDLSetting.getCategory())).append("</category_id>\n");
    ...
    private String createXML(final ExportExcelSetting exportExcelSetting, final PersistentContext context) {
        final StringBuilder xml = new StringBuilder();

        xml.append("<export_excel_setting>\n");

        xml.append("\t<category_id>").append(context.nodeElementMap.get(exportExcelSetting.getCategory())).append("</category_id>\n");
        xml.append("\t<output_path>").append(escape(exportExcelSetting.getExcelOutput())).append("</output_path>\n");
        xml.append("\t<template>").append(escape(exportExcelSetting.getExcelTemplate())).append("</template>\n");
        xml.append("\t<template_path>").append(escape(exportExcelSetting.getExcelTemplatePath())).append("</template_path>\n");
        xml.append("\t<used_default_template_lang>").append(escape(exportExcelSetting.getUsedDefaultTemplateLang())).append("</used_default_template_lang>\n");
        xml.append("\t<image_output>").append(escape(exportExcelSetting.getImageOutput())).append("</image_output>\n");
        xml.append("\t<is_open_after_saved>").append(exportExcelSetting.isOpenAfterSaved()).append("</is_open_after_saved>\n");
        xml.append("\t<is_put_diagram>").append(exportExcelSetting.isPutERDiagramOnExcel()).append("</is_put_diagram>\n");
        xml.append("\t<is_use_logical_name>").append(exportExcelSetting.isUseLogicalNameAsSheet()).append("</is_use_logical_name>\n");
    ...
    private String createXML(final ExportImageSetting exportImageSetting, final PersistentContext context) {
        final StringBuilder xml = new StringBuilder();

        xml.append("<export_image_setting>\n");

        xml.append("\t<output_file_path>").append(escape(exportImageSetting.getOutputFilePath())).append("</output_file_path>\n");
        xml.append("\t<category_dir_path>").append(escape(exportImageSetting.getCategoryDirPath())).append("</category_dir_path>\n");
        xml.append("\t<with_category_image>").append(exportImageSetting.isWithCategoryImage()).append("</with_category_image>\n");
        xml.append("\t<is_open_after_saved>").append(exportImageSetting.isOpenAfterSaved()).append("</is_open_after_saved>\n");
    ...
    private String createXML(final ExportJavaSetting exportJavaSetting, final PersistentContext context) {
        final StringBuilder xml = new StringBuilder();
    ...
    private String createXML(final ExportTestDataSetting exportTestDataSetting, final PersistentContext context) {
        final StringBuilder xml = new StringBuilder();
    ...
    private String createXML(final CategorySetting categorySettings, final PersistentContext context) {
        final StringBuilder xml = new StringBuilder();
    ...
    private String createXML(final TranslationSetting translationSettings, final PersistentContext context) {
        final StringBuilder xml = new StringBuilder();
        ...
        for (final String translation : translationSettings.getSelectedTranslations()) {
            xml.append(tab(tab(createTranslationXML(translation, context))));
        }
    ...
    private String createXML(final Category category, final boolean isSelected, final PersistentContext context) {
        final StringBuilder xml = new StringBuilder();

        xml.append("<category>\n");

        xml.append(tab(createXMLNodeElement(category, context)));
    ...
    private String createTranslationXML(final String translation, final PersistentContext context) {
        final StringBuilder xml = new StringBuilder();
    ...
    private String createXML(final NodeSet contents, final PersistentContext context) {
        final StringBuilder xml = new StringBuilder();
    ...
    private String createXMLNodeElement(final NodeElement nodeElement, final PersistentContext context) {
        final StringBuilder xml = new StringBuilder();
        ...
        xml.append(createXMLColor(nodeElement.getColor()));

        final List<ConnectionElement> incomings = nodeElement.getIncomings();
        xml.append(createXMLConnections(incomings, context));

        return xml.toString();
    }

    private String createXMLColor(final int[] colors) {
        final StringBuilder xml = new StringBuilder();
    ...
    private String createXML(final ERTable table, final PersistentContext context) {
        final StringBuilder xml = new StringBuilder();

        xml.append("<table>\n");

        xml.append(tab(createXMLNodeElement(table, context)));
        ...
        final List<Column> columns = table.getColumns();
        xml.append(tab(createXMLColumns(columns, context)));

        final List<Index> indexes = table.getIndexes();
        xml.append(tab(createXMLIndexes(indexes, context)));

        final List<ComplexUniqueKey> complexUniqueKeyList = table.getComplexUniqueKeyList();
        xml.append(tab(createXMLComplexUniqueKeyList(complexUniqueKeyList, context)));
    ...
    private String createXML(final View view, final PersistentContext context) {
        final StringBuilder xml = new StringBuilder();

        xml.append("<view>\n");

        xml.append(tab(createXMLNodeElement(view, context)));
    ...
    private String createXML(final ModelProperties modelProperties, final PersistentContext context) {
        final StringBuilder xml = new StringBuilder();

        xml.append("<model_properties>\n");

        xml.append(tab(createXMLNodeElement(modelProperties, context)));
    ...
    private String createXML(final NameValue property, final PersistentContext context) {
        final StringBuilder xml = new StringBuilder();
    ...
    private String createXML(final Note note, final PersistentContext context) {
        final StringBuilder xml = new StringBuilder();

        xml.append("<note>\n");

        xml.append(tab(createXMLNodeElement(note, context)));
    ...
    private String createXML(final InsertedImage insertedImage, final PersistentContext context) {
        final StringBuilder xml = new StringBuilder();

        xml.append("<image>\n");

        xml.append(tab(createXMLNodeElement(insertedImage, context)));
    ...
    private String createXMLColumns(final List<Column> columns, final PersistentContext context) {
        final StringBuilder xml = new StringBuilder();
        ...
        for (final Column column : columns) {
            ...
            if (column instanceof ColumnGroup) {
                xml.append(tab(createXMLId((ColumnGroup) column, context)));
    ...
    private String createXMLId(final ColumnGroup columnGroup, final PersistentContext context) {
        final StringBuilder xml = new StringBuilder();
    ...
    private String createXMLConnections(final List<ConnectionElement> incomings, final PersistentContext context) {
        final StringBuilder xml = new StringBuilder();
    ...
    private String createXMLConnectionElement(final ConnectionElement connection, final PersistentContext context) {
        final StringBuilder xml = new StringBuilder();
        ...
        xml.append("\t<source_xp>").append(connection.getSourceXp()).append("</source_xp>\n");
        xml.append("\t<source_yp>").append(connection.getSourceYp()).append("</source_yp>\n");
        xml.append("\t<target_xp>").append(connection.getTargetXp()).append("</target_xp>\n");
        xml.append("\t<target_yp>").append(connection.getTargetYp()).append("</target_yp>\n");

        for (final Bendpoint bendpoint : connection.getBendpoints()) {
            xml.append(tab(this.createXML(bendpoint)));
        }

        xml.append(tab(createXMLColor(connection.getColor())));

        return xml.toString();
    }

    private String createXML(final Bendpoint bendpoint) {
        final StringBuilder xml = new StringBuilder();
    ...
    private String createXML(final CommentConnection connection, final PersistentContext context) {
        final StringBuilder xml = new StringBuilder();

        xml.append("<comment_connection>\n");

        xml.append(tab(createXMLConnectionElement(connection, context)));
    ...
    private String createXML(final Relation relation, final PersistentContext context) {
        final StringBuilder xml = new StringBuilder();

        xml.append("<relation>\n");

        xml.append(tab(createXMLConnectionElement(relation, context)));
        ...
        xml.append("\t<referenced_complex_unique_key>").append(context.complexUniqueKeyMap.get(relation.getReferencedComplexUniqueKey())).append("</referenced_complex_unique_key>\n");
    ...
    private String createXMLIndexes(final List<Index> indexes, final PersistentContext context) {
        final StringBuilder xml = new StringBuilder();
    ...
    private String createXMLComplexUniqueKeyList(final List<ComplexUniqueKey> complexUniqueKeyList, final PersistentContext context) {
        final StringBuilder xml = new StringBuilder();
    ...
    private String createXML(final EnvironmentSetting environmentSetting, final PersistentContext context) {
        final StringBuilder xml = new StringBuilder();
    ...
    private String createXML(final MySQLTableProperties tableProperties) {
        final StringBuilder xml = new StringBuilder();
        ...
        xml.append("<primary_key_length_of_text>").append(tableProperties.getPrimaryKeyLengthOfText()).append("</primary_key_length_of_text>\n");

        return xml.toString();
    }

    private String createXML(final PostgresTableProperties tableProperties) {
        final StringBuilder xml = new StringBuilder();
    ...
    private String createXML(final ViewProperties viewProperties, final PersistentContext context) {
        final StringBuilder xml = new StringBuilder();
    ...
    private String createXML(final Index index, final PersistentContext context) {
        final StringBuilder xml = new StringBuilder();
    ...
    private String createXML(final ComplexUniqueKey complexUniqueKey, final PersistentContext context) {
        final StringBuilder xml = new StringBuilder();
    ...
    private String createXML(final Dictionary dictionary, final PersistentContext context) {
        final StringBuilder xml = new StringBuilder();
    ...
    private String createXML(final Word word, final PersistentContext context) {
        final StringBuilder xml = new StringBuilder();
        ...
        xml.append("\t<zerofill>").append(word.getTypeData().isZerofill()).append("</zerofill>\n");
        xml.append("\t<binary>").append(word.getTypeData().isBinary()).append("</binary>\n");
        xml.append("\t<args>").append(escape(word.getTypeData().getArgs())).append("</args>\n");
        xml.append("\t<char_semantics>").append(word.getTypeData().isCharSemantics()).append("</char_semantics>\n");

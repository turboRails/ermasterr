...
public class ExportWarningDialog extends ExportErrorDialog {
    ...
    public ExportWarningDialog(final Shell parentShell, final List<ValidateResult> errorList) {
    ...
    protected void createButtonsForButtonBar(final Composite parent) {
        createButton(parent, IDialogConstants.OK_ID, ResourceString.getResourceString("label.button.continue"), true);

...
public class ModelPropertiesDialog extends AbstractDialog {
    ...
    public ModelPropertiesDialog(final Shell parentShell, final ModelProperties modelProperties) {
        super(parentShell);
    ...
    private void createButtonComposite(final Composite parent) {
        ...
        addButton.setText(ResourceString.getResourceString("label.button.add"));
        ...
        deleteButton.setText(ResourceString.getResourceString("label.button.delete"));
        ...
        upButton.setText(ResourceString.getResourceString("label.up.arrow"));
        ...
        downButton.setText(ResourceString.getResourceString("label.down.arrow"));
